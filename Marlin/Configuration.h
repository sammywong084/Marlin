...
#define CUSTOM_MACHINE_NAME "E3 Dual-Z 2.1.2.6 122325"
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  // Creality Ender-3
    ...
    #define DEFAULT_KD_LIST {  67.56,  67.56 }
  #else
    #define DEFAULT_KP  30.56
    #define DEFAULT_KI   3.46
    #define DEFAULT_KD  67.56
  #endif
#else
...
#define PIDTEMPBED
  ...
  #define DEFAULT_BED_KP  48.89
  #define DEFAULT_BED_KI   5.90
  #define DEFAULT_BED_KD 270.33
